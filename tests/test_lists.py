...
def test_unordered_marker_span_returns_start_and_end_of_marker():
...
def test_ordered_number_span_returns_start_and_end_of_number():
    assert ordered_number_span("12. item") == (0, 2)
