...
def test_unordered_marker_span_returns_the_marker_position():
    assert unordered_marker_span("  - one") == (2, 3)


def test_unordered_marker_span_returns_none_for_non_list_lines():
...
def test_ordered_number_span_returns_none_for_non_list_lines():
